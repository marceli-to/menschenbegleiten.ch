...
<section class="pt-100 md:pt-140 xl:pt-200 pb-40 md:pb-80">
  <x-layout.inner class="relative z-20">
    ...
    <div class="max-w-prose">
      ...
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Hosting Provider &amp; Server-LogFiles</h2>
      ...
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Kontaktformular</h2>
      ...
      <p>Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per E-Mail an <a href="mailto:info@menschenbegleiten.ch ">info@menschenbegleiten.ch </a> zu widerrufen. In einem solchen Fall kann die Konversation nicht fortgeführt werden.</p>
      <p>Alle personenbezogenen Daten, die im Zuge der Kontaktaufnahme gespeichert wurden, werden in diesem Fall gelöscht.</p>
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Google Analytics</h2>
      ...
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Google Maps</h2>
      <strong>Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</strong><br>
      ...
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Recht auf Auskunft, Löschung, Sperrung</h2>
      <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an <a href="mailto:info@menschenbegleiten.ch " target="_blank">info@menschenbegleiten.ch </a> senden.</p>
      <h2 class="text-sm md:text-md xl:text-lg mb-10 mt-20 xl:mt-40">Verwendung von Adobe Fonts</h2>
