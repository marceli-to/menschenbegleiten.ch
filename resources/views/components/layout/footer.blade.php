  ...
  <x-layout.inner class="relative z-60">
    <div class="flex flex-col gap-y-20 md:gap-y-30 lg:grid lg:grid-cols-12 lg:gap-x-40 lg:items-center">
      <div class="md:col-span-full lg:col-span-9 lg:flex lg:justify-start lg:items-center lg:gap-x-60 xl:gap-x-80">
        ...
        <address class="md:hidden not-italic mt-20">
          Breitenstrasse 6<br>
          6403 Küssnacht am Rigi<br>T. <a href="tel:041 852 05 04" class="no-underline hover:underline underline-offset-4 decoration-1" title="Rufen Sie uns an">041 852 05 04</a><br>
          <a href="mailto:info@menschenbegleiten.ch" class="no-underline hover:underline underline-offset-4 decoration-1" title="Schreiben Sie uns eine E-Mail">info@menschenbegleiten.ch</a>
        </address>
        <address class="hidden md:block not-italic md:mt-30 lg:mt-0">
          Breitenstrasse 6 · 6403 Küssnacht am Rigi<br>T. <a href="tel:041 852 05 04" class="no-underline hover:underline underline-offset-4 decoration-1" title="Rufen Sie uns an">041 852 05 04</a> · <a href="mailto:info@menschenbegleiten.ch" class="no-underline hover:underline underline-offset-4 decoration-1" title="Schreiben Sie uns eine E-Mail">info@menschenbegleiten.ch</a>
        </address>
      </div>
